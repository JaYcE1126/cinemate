...
public class GetMoviePlotAction extends GetMovieAction{
	private static final Logger logger = LoggerFactory.getLogger(GetMoviePlotAction.class);

	public GetMoviePlotAction(String userInput, Session session){
	...
	private void actionSuccess(){
		...
		alexaResponse.setInitSentence(Sentences.moviePlot(super.movie));
		alexaResponse.setRepromptSentence(Sentences.moviePlotReprompt);
